...
void drawCircle(SDL_Renderer *_renderer, int _x0, int _y0, int _radius);
...
int main()
{
	...
	SDL_RenderPresent(renderer);
		...
		for(int i=0; i<radius; ++i)
		{
			...
			drawCircle(renderer,x0,y0,i);
			// // we need to anti-alias this else we get
			// // gaps
			// drawCircle(renderer,x0+1,y0-1,i);
			// drawCircle(renderer,x0,y0+1,i);
			// drawCircle(renderer,x0-1,y0,i);
			// drawCircle(renderer,x0+1,y0,i);
