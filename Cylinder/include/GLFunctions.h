...
class GLFunctions
{
  public :
    ...
    static void torus( float _minorRadius, float _majorRadius,int _nSides, int _nRings,const bool _flipTX=false );
    static void cylinderFrom(Vec4 _from, Vec4 _dir,float _radius,const float _height, int _slices, int _stacks );
